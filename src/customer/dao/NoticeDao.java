...
public class NoticeDao {
	...
	// getNotice를 호출하는 Edit의 오류를 없애주기 위해 메소드 추가함 (Edit는 seq만 보내주기 때문)
	...
	// <방법2> hit 메소드 (hit를 리턴해주는 메소드)
	public int hitUpdate2(String seq, String hit) throws Exception {
